...
export default function PhotoshopPage() {
  ...
  const filteredShortcuts = useMemo(() => {
    return shortcuts
      .filter(shortcut => shortcut.software === 'photoshop')
      .filter(shortcut => {
  ...
  const categories = useMemo(() => {
    const categorySet = new Set(shortcuts.filter(s => s.software === 'photoshop').map(s => s.category));
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Adobe Photoshop</h1>
              <p className="text-gray-600">Adobe Photoshopの便利なショートカットキーを学びましょう</p>
            </div>
