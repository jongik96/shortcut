...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://learnshortcuts.dev/${locale}/`,
      languages: {
        'ja': 'https://learnshortcuts.dev/ja/',
        'en': 'https://learnshortcuts.dev/en/',
        'ko': 'https://learnshortcuts.dev/ko/',
        'ar': 'https://learnshortcuts.dev/ar/',
        'x-default': 'https://learnshortcuts.dev/ja/',
      },
    },
    openGraph: {
      title,
